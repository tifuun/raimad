...
from PyCIF.draw.Option import Option, Shadow
...
def update_layers(Layers: dict, base: type):
    ...
    for i, (name, layer) in enumerate(Layers.items()):
        ...
        new_layers[name] = Layer(*layer, index=i)
...
class ComponentMeta(type):
    def __new__(cls, name, bases, namespace):
        ...
        update_options(namespace['Options'], base)
        update_layers(namespace['Layers'], base)

        new_component = super().__new__(cls, name, (base, ), namespace)
...
class Component(Markable):
    ...
    Class for base component
    """
    Options = Dotdict()  # TODO safe putting mutable here??
    Layers = Dotdict()
